...
class BookingQuery {
  ...
  async getAllBookingList() {
    const query = `SELECT  a.booking_id, a.tanggal_booking, a.jam_booking, b.email, b.nama as nama_penyewa, b.no_hp,c.transaksi_id, d.product_id, c.total_lama_sewa, d.nama, (c.produk::json->'jamMain')::varchar as booked FROM booking_tb a 
